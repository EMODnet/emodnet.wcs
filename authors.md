...
- **European Marine Observation Data Network (EMODnet) Biology project
  ...
  Fisheries (DG MARE)**. Copyright holder.

- **VLIZ (VLAAMS INSTITUUT VOOR DE ZEE)**. Funder.
  [![ROR](https://raw.githubusercontent.com/ror-community/ror-logos/main/ror-icon-rgb.svg)](https://ror.org/0496vr396)
...
0.0.2.9000. Integrated data products created under the European Marine
