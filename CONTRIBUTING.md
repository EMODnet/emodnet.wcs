# Contributing to EMODnetWCS

This outlines how to propose a change to EMODnetWCS.
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("EMODnet/EMODnetWCS", fork = TRUE)`.
...
- We use [testthat](https://cran.r-project.org/package=testthat) and
  [httptest](https://books.ropensci.org/http-testing/httptest.html) for
...
Code of
Conduct](https://emodnet.github.io/emodnet.wcs/CODE_OF_CONDUCT.md). By
